...
import com.example.maliba.Publicimage.getimages;
...
public class Privateimage extends Activity    {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.privateimage);
		...
		l12.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				ScrollView sv = new ScrollView(Privateimage.this);
				LinearLayout l1 = new LinearLayout(Privateimage.this);
				
				sv.addView(l1);
				l1.setOrientation(1);
				ImageView i11 = new ImageView(Privateimage.this);
				
				TextView t11 = new TextView(Privateimage.this);
				...
				new AlertDialog.Builder(Privateimage.this)
	...
	class getimages extends AsyncTask<Void, Void, String>
	{
		...
		protected String doInBackground(Void... params) {
			...
			try
			{
				SoapObject request = new SoapObject(MainActivity.NAMESPACE, "getprivateimages");
		       ...
		       request.addProperty("Images","1");
		        ...
		        androidHttpTransport.call("http://tempuri.org/getprivateimages", envelope);
...
//		        Toast.makeText(Reg.this, resultstr.toString(), Toast.LENGTH_SHORT).show();
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pdia = new ProgressDialog(Privateimage.this);
		...
		protected void onPostExecute(String result) {
			...
			NewsRowAdapter a12 = new NewsRowAdapter(Privateimage.this,R.layout.row,items);
			l12.setAdapter(a12);
			}
